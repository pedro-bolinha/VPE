export const empresas = [
  {
    name: "FAMPEPAR",
    descricao: "A FAMPEPAR é uma empresa tradicional no ramo de confeitaria popular, especializada na produção e venda de balas e pirulitos artesanais. Com uma base fiel de clientes escolares e eventos regionais, possui forte presença em feiras e mercados locais.",
  ...
  {
    name: "Basket Pro",
    descricao: "A Basket Pro é uma loja especializada em artigos esportivos com foco em basquete. Comercializa bolas profissionais, uniformes, tabelas e acessórios. Atua tanto no varejo físico quanto no e-commerce.",
